...
private:
	...
	//新的自增的序列号
	unsigned long long m_increaseID;
	...
	//设置自增序列号
	void SetIncreaseID(unsigned long long id);
...
public:
	...
	//得到新自增的序列号
	unsigned long long GetIncreaseID();
	...
	virtual long long GetItemLongLong(unsigned long row,
		const unsigned int index);
